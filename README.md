...
## Environments
- Preview: https://main--majorleaguecricket-da-2--aemysites.aem.page/
- Live: https://main--majorleaguecricket-da-2--aemysites.aem.live/
- Block Library: https://main--majorleaguecricket-da-2--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `majorleaguecricket-da-2` directory in your favorite IDE and start coding :)
